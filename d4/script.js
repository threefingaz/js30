...
const boulevards = Array.from(document.querySelectorAll('.boulevards .mw-category a'));
const de = boulevards
...
const data_instances = data.reduce((result, item) => {
